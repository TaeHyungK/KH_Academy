...
<html>
  <head>
    ...
    <title>reservation updateForm</title>
    <!-- Bootstrap core CSS -->
      ...
      <div class="bg-faded p-4 my-4">
		...
		<ul>
			<li>
				...
				<input type="text" name="departure" id="departure" width="500">     
			</li>
			<li>
				<label for="destination">destination</label>
				<input type="text" name="destination" id="destination" width="500">
			</li>
			<li>
				<label for="ap_num">ap_num</label>
				<input type="text" name="ap_num" id="ap_num" size="15">
			</li>
		</ul>
