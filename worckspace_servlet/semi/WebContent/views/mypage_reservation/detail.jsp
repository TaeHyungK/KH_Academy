        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav mx-auto">
            ...
            <li class="nav-item active px-lg-4">
              <a class="nav-link text-uppercase text-expanded" href="../reservation/registerDetail.do">MyPage</a>
            </li>
      ...
      <div class="bg-faded p-4 my-4">
        ...
        <form action="detail.do" method="post" id="detail_form">
			...
			<ul>
				...
				<li>ap_num: ${reservation.ap_num}</li>
				<li>rsv_num: ${reservation.rsv_num}</li>
				<li>departure: ${reservation.departure}</li>
				<li>destination: ${reservation.destination}</li>
				<li>regdate: ${reservation.regdate}</li>
			</ul>
		...
		<div class="align-center">
			...
			onclick="location.href='modifyUserForm.do?rsv_num=${reservation.rsv_num}'"
			<c:if test="${user_id !=register_1.id}">disabled="disabled"</c:if>
			>
			<input type="button" value="delete"
			onclick="location.href='deleteUserForm.do?rsv_num=${reservation.rsv_num}'"
			<c:if test="${user_id !=register_1.id}">disabled="disabled"</c:if>
			>
