...
public interface BoardMapper {
	...
	@Insert("INSERT INTO spboard(num,title,content,regdate,uploadfile,filename,ip,id) VALUES(board_seq.nextval,#{title},#{content},sysdate,#{uploadfile},#{filename},#{ip},#{id})")
	...
	public void deleteReply(Integer re_num);//Integer : mybatis다 객체로 인식하기때문에 int 아니고 Integer라고 명시
