            ...
            <div class="navbar-collapse collapse">
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        ...
                        <ul class="dropdown">
                        <li>
                       		<a class="active" href="${pageContext.request.contextPath}/academy/academyInfo.do">학원 정보 보기</a> <!-- 학원 정보 등록, 수정 -->
                       	</li>
                       	<li>
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="contact-section">
				...
				<br/>
				<input type="submit" name="submit" class="btn btn-primary" id="submit_btn" value="강의 정보 보기">
