		...
		<div class="contact-section" >
			<form:form commandName="teacher" action="insert.do" id="cform"
				...
				<div class="form-group">
					<label for="t_name">강사 이름<span class="required">*</span></label>
					<form:input path="t_name" class="form-control"/>
				</div>
				
				<div class="form-group">
				<label for="t_content">강사 소개</label>
					<form:textarea path="t_content" class="form-control" placeholder="Message" maxlength="140" rows="7"/>
				</div>
