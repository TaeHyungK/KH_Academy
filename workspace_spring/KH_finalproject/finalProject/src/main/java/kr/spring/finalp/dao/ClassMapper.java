...
public interface ClassMapper {
	...
	//수정용 정보가져오기
	@Select("SELECT * from class where a"
			+ "_num=#{a_num} and c_num=#{c_num}")
	public ClassCommand updateCompare(Map<Object,Object> map);
	
	//수강신청
	@Insert("INSERT INTO complete(my_num, total_price, m_num, c_num) VALUES (#{my_num},#{total_price},#{m_num},#{c_num})")
