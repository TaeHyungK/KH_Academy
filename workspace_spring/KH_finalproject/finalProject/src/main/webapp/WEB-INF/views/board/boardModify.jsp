            ...
            <div class="form-test">
               <div class="form-area">
                  <div class="contact-section">
                     <form:form commandName="command" action="update.do" id="update_form">
                        <form:errors element="div" cssClass="error-color"/>
                        <h3 style="margin-bottom: 25px; text-align: center;">Update Form</h3>
                        <form:hidden path="m_num" />
                        <form:hidden path="ib_num" />
                     
                        <div class="form-group">
                           <label for="ib_title">제목<span class="required">*</span></label>
                           <form:input path="ib_title" class="form-control" />
                        </div>
                        
                        <div class="form-group">
                           <label for="ib_content">내용<span class="required">*</span></label>
