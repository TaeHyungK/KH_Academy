            ...
            <div class="page-title">
                <div class="page-title-overlay">
                    ...
                    <div>
						<ul class="breadcrumb">
							<li><a href="">Home</a></li>
							<li class="active">Academy Information</li>
						</ul>
					</div>
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="contact-section">
				...
				<br/>
				<input type="button" onclick="location.href='${pageContext.request.contextPath}/class/classMain.do'"class="btn btn-primary"  value="강의 정보 보기">
				<!-- End Contact Form -->
            </div>
        </div>
