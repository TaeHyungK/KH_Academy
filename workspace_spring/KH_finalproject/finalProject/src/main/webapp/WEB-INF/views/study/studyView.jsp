...
<script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/study.reply.js"></script>
<div class="container">
   ...
   <div class="col-md-8 col-sm-i">
      ...
      <hr>
      <ul>
         <li>글번호 : ${form.sb_num}</li>
         <li>작성자 : ${form.m_id}</li>
         <li>모집인원 : ${form.sb_count}</li>
         <li>조회수 : ${form.sb_hit}</li>
         <li>작성날짜 : ${form.sb_date}</li>
      </ul>
      ...
      <div class="align-right">
         ...
         <input type="button" value="수정" class="btn btn-primary"
            onclick="location.href='sbupdate.do?sb_num=${form.sb_num}'">
         <input type="button" value="삭제" class="btn btn-primary"
            onclick="location.href='sbdelete.do?sb_num=${form.sb_num}'">
         </c:if>   
         <input type="button" value="목록" class="btn btn-primary"
            onclick="location.href='sblist.do'">
         </p>
      </div>
      ...
      <div id="reply_div">
         <form id="re_form">
            ...
            <input type="hidden" name="sb_num" value="${form.sb_num}" id="sb_num">

            <textarea rows="3" cols="100" name="sc_content" id="sc_content"
               class="rep-content"
