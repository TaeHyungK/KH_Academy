      ...
      <div class="navbar navbar-default navbar-top">
         ...
         <div class="navbar-collapse collapse">
            ...
            <ul class="nav navbar-nav">
               ...
               <li><a href="${pageContext.request.contextPath}/academy/academyMain.do">소개</a>
                  <!-- 학원소개/강사진소개 -->
                  <ul class="dropdown">
         ...
         <div class="form-test">
            <div class="form-area">
               <div class="contact-section" >
                  <form:form commandName="command" action="sbwrite.do" id="write_form">
                        <form:errors element="div" cssClass="error-color"/>
                        <h3 style="margin-bottom: 25px; text-align: center;">Write Form</h3>
                        <form:hidden path="m_num" />
                     
                        <div class="form-group">
                           <label for="sb_title">제목<span class="required">*</span>&nbsp;<form:errors path="sb_title" cssClass="error-color"/></label>
                           <form:input path="sb_title" class="form-control" />
                           
                        </div>
                        
                        <div class="form-group">
                           <label for="sb_content">내용<span class="required">*</span>&nbsp;<form:errors path="sb_content" cssClass="error-color"/></label>
