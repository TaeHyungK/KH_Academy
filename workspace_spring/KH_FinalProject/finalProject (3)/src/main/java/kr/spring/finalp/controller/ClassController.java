...
public class ClassController {
   ...
   public String insertForm(HttpSession session,Model model, ClassCommand classCommand,
      ...
      TeacherCommand teacher = teacherService.selectTeacher(id);
      
      if(academy == null) {
         request.setAttribute("message", "학원을 등록해주세요.");
         request.setAttribute("url", "../academy/insert.do");
         return "common/messageUrl";
      }else if(teacher == null){
         request.setAttribute("message", "강사를 등록해주세요.");
         request.setAttribute("url", "../teacher/insert.do");
         return "common/messageUrl";
      }else {
