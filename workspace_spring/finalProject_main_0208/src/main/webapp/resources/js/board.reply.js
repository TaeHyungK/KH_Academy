$(document).ready(function(){
      ...
      success:function(data){
         ...
         if(count<0 || list==null){
            ...
            $(list).each(function(index,item){
               ...
               output += '   <p>'+item.ic_content+'</p>';
               output +=       item.ic_regdate;
   ...
   $(document).on('click','.modify-btn',function(){
      ...
      modifyUI += '<textarea rows="3" cols="100" name="ic_content" id="mre_content" class="rep-content">'+ic_content+'</textarea>';
      modifyUI += '<div id="mre_first"><span class="letter-count">300/300</span></div>';
      modifyUI += '<div id="mre_second" class="align-right">';
      modifyUI += '<input type="submit" value="확인" class="btn btn-primary">		';
      modifyUI += '<input type="button" value="취소" class="btn btn-primary re-reset">';
      modifyUI += '</div>';
      modifyUI += '</form>';
