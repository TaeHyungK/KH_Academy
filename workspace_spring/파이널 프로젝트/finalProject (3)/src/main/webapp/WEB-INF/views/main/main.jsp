                    ...
                    <ul id="portfolio-list" data-animated="fadeIn">
                        ...
                        <li>
                        	<div class="portfolio-item">
                                ...
                                <div class="figure-caption">
                                    <h4>${topItem.t_name}</h4>
                                    <p>
                                    	<i class="fas fa-address-card"></i>${topItem.t_content}<br/>
                                    	<i class="fas fa-clipboard"></i>${topItem.t_record}<br/>
                                    	<i class="fa fa-thumbs-up"></i>${topItem.t_good}
                                    </p>
